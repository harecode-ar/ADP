      ...
      try {
        ...
        const query = `
          SELECT
            ...
            COUNT(CASE WHEN stateId = ${TASK_STATE.IN_PROGRESS} OR stateId = ${TASK_STATE.ON_HOLD} THEN 1 END) AS inProgress,
      ...
      try {
        ...
        const query = `
          SELECT
            ...
            SUM(CASE WHEN stateId = ${TASK_STATE.IN_PROGRESS} or stateId = ${TASK_STATE.ON_HOLD} THEN cost END) AS inProgress,

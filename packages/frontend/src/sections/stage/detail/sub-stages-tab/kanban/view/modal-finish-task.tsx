...
export default function ModalFinishTask(props: TProps) {
  const { modal, project, stage, subStage, refetch } = props
  const [startTask, { loading }] = useMutation(FINISH_TASK)
  ...
  const onAccept = async () => {
    ...
    try {
      ...
      enqueueSnackbar('La tarea ha finalizado correctamente.', { variant: 'success' })
      modal.onFalse()
      refetch()
    } catch (error) {

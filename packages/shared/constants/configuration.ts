...
export const CONFIGURATION_DESCRIPTIONS: Record<EConfigurationKey, string> = {
  [EConfigurationKey.PERCENTAGE_ALERT_MARGIN_PROJECT]: 'Es el porcentaje de margen de alerta de proyectos',
  [EConfigurationKey.PERCENTAGE_ALERT_MARGIN_STAGE]: 'Es el porcentaje de margen de alerta de etapas'
}
